...
public class CustomSpiderSouth extends EntitySpider {
   
    private static CustomSpiderSouth SpiderSouth;

    public CustomSpiderSouth(World world, Location loc, Location dest) {
        super(world);
       
        setCustomName("SpiderS");
    ...
    public static CustomSpiderSouth getSpider() {
        return SpiderSouth;
    }
}
