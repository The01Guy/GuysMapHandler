...
public class CustomSpiderNorth extends EntitySpider {
   
    private static CustomSpiderNorth SpiderNorth;

    public CustomSpiderNorth(World world, Location loc, Location dest) {
        super(world);
       
        setCustomName("SpiderN");
    ...
    public static CustomSpiderNorth getSpider() {
