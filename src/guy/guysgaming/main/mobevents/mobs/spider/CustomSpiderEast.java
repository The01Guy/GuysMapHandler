...
public class CustomSpiderEast extends EntitySpider {
   
    private static CustomSpiderEast SpiderEast;

    public CustomSpiderEast(World world, Location loc, Location dest) {
        super(world);
       
        setCustomName("SpiderE");
    ...
    public static CustomSpiderEast getSpider() {
        return SpiderEast;
    }
}
