...
public class CustomZombieSouth extends EntityZombie {
   
    private static CustomZombieSouth ZombieSouth;

    public CustomZombieSouth(World world, Location loc, Location dest) {
        super(world);
       
        setCustomName("ZombieS");
    ...
    public static CustomZombieSouth getZombie() {
        return ZombieSouth;
    }    
}