...
public class CustomZombieNorth extends EntityZombie {
   
    private static CustomZombieNorth ZombieNorth;
    
    public CustomZombieNorth(World world, Location loc, Location dest) {
        super(world);
       
        setCustomName("ZombieN");
    ...
    public static CustomZombieNorth getZombie() {
        System.out.println("getZombie() called");
        return ZombieNorth;
    }
}