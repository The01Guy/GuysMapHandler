...
public class CustomCreeperNorth extends EntityCreeper {
   
    private static CustomCreeperNorth CreeperNorth;

    public CustomCreeperNorth(World world, Location loc, Location dest) {
        super(world);
       
        setCustomName("CreeperN");
    ...
    public static CustomCreeperNorth getCreeper() {
        return CreeperNorth;
    }
}
