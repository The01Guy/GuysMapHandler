...
public class CustomCreeperSouth extends EntityCreeper {
   
    private static CustomCreeperSouth CreeperSouth;

    public CustomCreeperSouth(World world, Location loc, Location dest) {
        super(world);
       
        setCustomName("CreeperS");
    ...
    public static CustomCreeperSouth getCreeper() {
        return CreeperSouth;
    } 
}
