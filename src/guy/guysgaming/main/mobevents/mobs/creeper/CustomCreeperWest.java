...
public class CustomCreeperWest extends EntityCreeper {
   
    private static CustomCreeperWest CreeperWest;

    public CustomCreeperWest(World world, Location loc, Location dest) {
        super(world);
       
        setCustomName("CreeperW");
    ...
    public static CustomCreeperWest getCreeper() {
        return CreeperWest;
    }
}
