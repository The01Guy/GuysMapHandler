...
import guy.guysgaming.main.mobevents.pathfindergoals.PathfinderGoalMoveSouth;
...
public class CustomSkeletonSouth extends EntitySkeleton {
   
    private static CustomSkeletonSouth SeletonSouth;

    public CustomSkeletonSouth(World world, Location loc, Location dest) {
        super(world);
       
        setCustomName("SkeletonS");
        ...
        this.goalSelector.a(5, new PathfinderGoalMoveSouth(this, dest, 1.0F));
    ...
    public static CustomSkeletonSouth getSkeleton() {
        return SeletonSouth;
    } 
